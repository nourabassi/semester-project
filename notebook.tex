...
\subsection{1. Introduction}\label{introduction}}
    ...
    \hypertarget{bibliometric-study-to-analyse-the-papers-published-in-the-proceeding-of-the-conferences-organized-by-the-international-learning-science-society.}{%
\subsection{Bibliometric study to analyse the papers published in the
Proceeding of the Conferences organized by the International Learning
Science
Society.}\label{bibliometric-study-to-analyse-the-papers-published-in-the-proceeding-of-the-conferences-organized-by-the-international-learning-science-society.}}
...
\subsubsection{2.1 Metadata}\label{metadata}}
...
{\color{incolor}In [{\color{incolor}2}]:} \PY{k+kn}{import} \PY{n+nn}{os} 
        ...
        \PY{n}{rootdir} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{data/papers}\PY{l+s+s1}{\PYZsq{}}
        \PY{n}{contents} \PY{o}{=} \PY{p}{[}\PY{p}{]}
        \PY{n}{i} \PY{o}{=} \PY{l+m+mi}{0}
        \PY{n}{source} \PY{o}{=} \PY{p}{[}\PY{p}{]}
        \PY{n}{errors} \PY{o}{=} \PY{p}{[}\PY{p}{]}
        \PY{n}{doc} \PY{o}{=} \PY{p}{[}\PY{p}{]}
        \PY{n}{year} \PY{o}{=} \PY{p}{[}\PY{p}{]}
        \PY{k}{for} \PY{n}{subdir}\PY{p}{,} \PY{n}{dirs}\PY{p}{,} \PY{n}{files} \PY{o+ow}{in} \PY{n}{os}\PY{o}{.}\PY{n}{walk}\PY{p}{(}\PY{n}{rootdir}\PY{p}{)}\PY{p}{:}
            \PY{k}{for} \PY{n+nb}{file} \PY{o+ow}{in} \PY{n}{files}\PY{p}{:}
                \PY{k}{if} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{txt}\PY{l+s+s1}{\PYZsq{}} \PY{o+ow}{in} \PY{n+nb}{file}\PY{p}{:}
                    \PY{n}{i} \PY{o}{+}\PY{o}{=} \PY{l+m+mi}{1}
                    \PY{n}{path} \PY{o}{=} \PY{n}{os}\PY{o}{.}\PY{n}{path}\PY{o}{.}\PY{n}{join}\PY{p}{(}\PY{n}{subdir}\PY{p}{,} \PY{n+nb}{file}\PY{p}{)}
                    \PY{k}{with} \PY{n+nb}{open}\PY{p}{(}\PY{n}{path}\PY{p}{)} \PY{k}{as} \PY{n+nb}{file}\PY{p}{:}
                        \PY{n}{doc}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{path}\PY{o}{.}\PY{n}{split}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZus{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{[}\PY{p}{:}\PY{l+m+mi}{3}\PY{p}{]}\PY{p}{)}
                        \PY{n}{year}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n+nb}{int}\PY{p}{(}\PY{n}{path}\PY{o}{.}\PY{n}{split}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{/}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{[}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{[}\PY{l+m+mi}{6}\PY{p}{:}\PY{l+m+mi}{10}\PY{p}{]}\PY{p}{)}\PY{p}{)}
                        \PY{k}{try}\PY{p}{:}
                            \PY{n}{text} \PY{o}{=} \PY{n+nb}{file}\PY{o}{.}\PY{n}{read}\PY{p}{(}\PY{p}{)}
                            \PY{k}{if} \PY{n+nb}{len}\PY{p}{(}\PY{n}{text}\PY{p}{)}\PY{o}{\PYZgt{}} \PY{l+m+mi}{10} \PY{p}{:}
                                \PY{n}{contents}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{text}\PY{p}{)}
                            \PY{n}{source}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{subdir}\PY{p}{[}\PY{n+nb}{len}\PY{p}{(}\PY{n}{rootdir}\PY{p}{)}\PY{p}{:}\PY{p}{]}\PY{p}{)}
                        \PY{k}{except}\PY{p}{:}
                            \PY{n}{name}\PY{p}{,} \PY{n}{message}\PY{p}{,} \PY{n}{content} \PY{o}{=} \PY{n}{sys}\PY{o}{.}\PY{n}{exc\PYZus{}info}\PY{p}{(}\PY{p}{)}
                            \PY{n}{errors}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{message}\PY{p}{)}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}5}]:} \PY{k}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Number of papers is : \PYZob{}\PYZcb{}}\PY{l+s+s1}{\PYZsq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{contents}\PY{p}{)}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
...
\subsection{Data Cleaning}\label{data-cleaning}}
    ...
    your part for the references universities parsing \ldots{}
...
caracters such as `\xe2\x80\x99s', white space strings \ldots{}
...
metadata and put assign to every document a publication year.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}7}]:} \PY{n}{keywords\PYZus{}df} \PY{o}{=} \PY{n}{pd}\PY{o}{.}\PY{n}{read\PYZus{}csv}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{keywords\PYZus{}final.csv}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}30}]:} \PY{k+kn}{import} \PY{n+nn}{matplotlib.pyplot} \PY{k+kn}{as} \PY{n+nn}{plt}
         ...
         \PY{n}{x} \PY{o}{=} \PY{n}{plt}\PY{o}{.}\PY{n}{hist}\PY{p}{(}\PY{n+nb}{list}\PY{p}{(}\PY{n}{keywords\PYZus{}df}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{year}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}\PY{p}{,} \PY{n}{bins}\PY{o}{=}\PY{l+m+mi}{7}\PY{p}{,}\PY{p}{)}
         \PY{n}{x} \PY{o}{=} \PY{n}{plt}\PY{o}{.}\PY{n}{xticks}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{arange}\PY{p}{(}\PY{n+nb}{min}\PY{p}{(}\PY{n}{keywords\PYZus{}df}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{year}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}\PY{p}{,}\PY{n+nb}{max}\PY{p}{(}\PY{n}{keywords\PYZus{}df}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{year}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{o}{+}\PY{l+m+mi}{1}\PY{p}{)} \PY{p}{,} \PY{l+m+mi}{1}\PY{p}{)}\PY{p}{)}
         \PY{n}{x} \PY{o}{=} \PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Distribution of the number of documents per year}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
\end{Verbatim}
...
below
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}33}]:} \PY{k+kn}{from} \PY{n+nn}{IPython.display} \PY{k+kn}{import} \PY{n}{Image}
         \PY{n}{Image}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{keywords\PYZus{}by\PYZus{}year.png}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
\end{Verbatim}
...
`reponsive' and in 2018 `tools' is present with more than 6\%.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}37}]:} \PY{n}{Image}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{distinct\PYZus{}words.png}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
\end{Verbatim}
