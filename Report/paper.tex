...
to one specific cluster.
    ...
    \begin{figure}
        \begin{center}\adjustimage{max size={\linewidth}{0.4\paperheight}}{paper_files/paper_41_0.png}\end{center}
...
in this figure \ref{fig6}
    ...
    \begin{figure}
        \begin{center}\adjustimage{max size={\linewidth}{0.4\paperheight}}{paper_files/paper_45_0.png}\end{center}
        \caption{}
        \label{}
    \end{figure}
...
biggest proportion of participants \ref{fig_rep}.
    ...
    \begin{figure}
        \begin{center}\adjustimage{max size={\linewidth}{0.4\paperheight}}{paper_files/paper_65_0.png}\end{center}
        \caption{Different formats used to reference institution}
        \label{figrep}
    \end{figure}
