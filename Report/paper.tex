...
to one specific cluster.
    ...
    \begin{figure}
        \begin{center}\adjustimage{max size={\linewidth}{0.4\paperheight}}{paper_files/paper_42_0.png}\end{center}
...
collaborative individuals. Hence we removed nodes that had fewer than 3
connections to other nodes. The resulting graph can be seen in figure
\ref{author_collab_large}. Details creating such a plot can be found in
the section dedicated to this below.
...
are represented in table \ref{indegree}:
    ...
    \begin{figure}
        \begin{center}\adjustimage{max size={\linewidth}{0.4\paperheight}}{paper_files/paper_84_0.png}\end{center}
...
component represented in the interactive graph \ref{fig11}.
    ...
    \begin{figure}
        \begin{center}\adjustimage{max size={\linewidth}{0.4\paperheight}}{paper_files/paper_95_0.png}\end{center}
    ...
    \begin{figure}
        \begin{center}\adjustimage{max size={\linewidth}{0.4\paperheight}}{paper_files/paper_96_0.png}\end{center}
...
clusters.
    ...
    \begin{figure}
        \begin{center}\adjustimage{max size={\linewidth}{0.4\paperheight}}{paper_files/paper_98_0.png}\end{center}
