...
\ref{Louvain} and Figure \ref{normalized}.
    ...
    \begin{figure}
        \begin{center}\adjustimage{max size={\linewidth}{0.4\paperheight}}{paper_files/paper_55_0.png}\end{center}
...
obtain the figure below:
    ...
    \begin{figure}
        \begin{center}\adjustimage{max size={\linewidth}{0.4\paperheight}}{paper_files/paper_72_0.png}\end{center}
        \caption{}
        \label{}
    \end{figure}
...
relevant and can be cited together.
    ...
    \begin{figure}
        \begin{center}\adjustimage{max size={\linewidth}{0.4\paperheight}}{paper_files/paper_77_0.png}\end{center}
        \caption{}
        \label{}
    \end{figure}
...
\end{Verbatim}
    ...
    \begin{figure}
        \begin{center}\adjustimage{max size={\linewidth}{0.4\paperheight}}{paper_files/paper_82_0.png}\end{center}
        \caption{}
        \label{}
    \end{figure}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}236}]:} <IPython.core.display.HTML object>
\end{Verbatim}
...
represented in the interactive graph above.
    ...
    \begin{figure}
        \begin{center}\adjustimage{max size={\linewidth}{0.4\paperheight}}{paper_files/paper_86_0.png}\end{center}
        \caption{}
        \label{}
    \end{figure}
...
than the latter are more likely to be about the same subect.
    ...
    \begin{figure}
        \begin{center}\adjustimage{max size={\linewidth}{0.4\paperheight}}{paper_files/paper_88_0.png}\end{center}
        \caption{}
        \label{}
    \end{figure}
